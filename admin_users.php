    ...
    if ($target_user_id === $user_id) {
        ...
        try {
            ...
            if (!$stmt_check->fetch()) {
                ...
                $stmt_up = $pdo->prepare("UPDATE users SET role=?, updated_at=NOW() WHERE user_id=?");
...
<!DOCTYPE html>
<html lang="fr">
<head><meta charset="UTF-8"><title><?= htmlspecialchars($gestion_title) ?></title>
<link rel="stylesheet" href="styles.css?v=final"></head>
